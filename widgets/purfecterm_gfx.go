...
//   - terminalLeftPadding is 0: tuitk widgets own their full bounds.
...
//   - Scrollbars are overlay lanes inside the widget (macOS style)
...
// screenToCellGfx maps widget-unit coordinates to buffer cells,
